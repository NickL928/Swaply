...
public class UpdateListingDto {
    ...
    public UpdateListingDto(String title, String description, BigDecimal price, Category category, ListingCondition condition, String imageUrl, ListingStatus status, Long userId) {
        this.title = title;
